...
print("\nHouse temperature sensor records for area {} ={}".format(test_date.strftime("%m/%d/%y"),len(recs)))
print("\tMaximum:{0},Minimum:{1} temperatures".format(max(recs),min(recs)))
...
print("\nHouse Humidity sensor records for area {} = {}".format(test_date.strftime("%m/%d/%y"),len(recs)))
print("\tAverage: {} humidity".format(mean(recs)))
